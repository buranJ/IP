...
export default function BurgerMenu() {
    ...
    return (
        <div className="BurgerMenu relative md:hidden " >
            ...
            <div className={`fixed top-0 right-0 h-full  w-64 bg-[#1b1b1b] text-white shadow-lg transition-transform duration-300  
              ${isOpen ? "translate-x-0" : "translate-x-full"}`} onClick={(e) => e.stopPropagation()}>
                <div className="burger__content px-[32px]  ">
                    <div className="burger__nav flex justify-between">
                        <button className="BurgerMenu__btn  " onClick={() => setIsOpen(false)}>
                    ...
                    <div className="BurgerMenu__follow ">
